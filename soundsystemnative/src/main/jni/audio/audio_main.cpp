...
#include "aaudio/utils/audio_common.h"
#include "SineGenerator.h"
#include "aaudio/utils/stream_builder.h"
...
Java_com_mercandalli_android_sdk_audio_SoundSystemNative_nativeCreate(JNIEnv *env,
                                                                      jclass);
JNIEXPORT void JNICALL
Java_com_mercandalli_android_sdk_audio_SoundSystemNative_nativeDestroy(JNIEnv *env,
                                                                       jclass type);
JNIEXPORT jboolean JNICALL
Java_com_mercandalli_android_sdk_audio_SoundSystemNative_nativeStart(JNIEnv *env, jclass type);
JNIEXPORT jboolean JNICALL
Java_com_mercandalli_android_sdk_audio_SoundSystemNative_nativeStop(JNIEnv *env, jclass type);
}
...
JNIEXPORT jboolean JNICALL
Java_com_mercandalli_android_sdk_audio_SoundSystemNative_nativeCreate(
        JNIEnv *env,
        jclass type) {
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_mercandalli_android_sdk_audio_SoundSystemNative_nativeStart(JNIEnv *env,
                                                                     jclass type) {
