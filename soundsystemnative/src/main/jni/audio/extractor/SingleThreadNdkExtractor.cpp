...
#include "SingleThreadNdkExtractor.h"
...
SingleThreadNdkExtractor::SingleThreadNdkExtractor(SoundSystem *soundSystem,
...
SingleThreadNdkExtractor::~SingleThreadNdkExtractor() {
    if (mlooper) {
...
bool SingleThreadNdkExtractor::extract(const char *filename) {
...
void SingleThreadNdkExtractor::extractMetadata(AMediaFormat *format) {
...
void SingleThreadNdkExtractor::setPlayingStreamingMediaPlayer(const bool isPlaying) {
